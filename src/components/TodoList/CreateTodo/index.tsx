		...
		<>
			...
			<form onSubmit={createTodo}>
				<div className={`flex items-center justify-center transition-all duration-500 text-center`}>
					<input ref={todoNameRef} maxLength={45} onChange={(event)=>{setTodoName(event.target.value);}} className="w-3/5 text-blue-500 font-extrabold placeholder-blue-400  py-1.5 px-2 border-blue-600 rounded border-2 focus:outline-none" type="text" placeholder="Digite o nome de sua tarefa aqui" aria-label="nome da tarefa" />
